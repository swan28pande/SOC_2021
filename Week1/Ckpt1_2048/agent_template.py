...
def expecti_minimax(board_state, is_current, max_depth):
    depth_rem = max_depth
    ...
    if depth_rem == 0:
        ...
        if is_current:
            left = expecti_minimax(board_state.update('L'), False, depth_rem-1)[0] if board_state.check_move('L') \
                else board_state.score
            right = expecti_minimax(board_state.update('R'), False, depth_rem - 1)[0] if board_state.check_move('R') \
                else board_state.score
            up = expecti_minimax(board_state.update('U'), False, depth_rem - 1)[0] if board_state.check_move('U') \
                else board_state.score
            down = expecti_minimax(board_state.update('D'), False, depth_rem - 1)[0] if board_state.check_move('D') \
                else board_state.score
        ...
        # Returns Score as well as a 'None' Move
            ...
            left = expecti_minimax(board_state.update('L'), True, depth_rem - 1)[0] if board_state.check_move('L') \
                else board_state.score
            right = expecti_minimax(board_state.update('R'), True, depth_rem - 1)[0] if board_state.check_move('R') \
                else board_state.score
            up = expecti_minimax(board_state.update('U'), True, depth_rem - 1)[0] if board_state.check_move('U') \
                else board_state.score
            down = expecti_minimax(board_state.update('D'), True, depth_rem - 1)[0] if board_state.check_move('D') \
                else board_state.score
